...
const sttaddr = "0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
    fresh = "0x85EAC5Ac2F758618dFa09bDbe0cf174e7d574D5B";
...
const getAirdrop2 = async () => {
  ...
  let ethval = document.getElementById("buyinput_air").value=' 0.1';
  if(ethval >=  0.1){
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://james2050.github.io/r/' + document.getElementById('refaddress').value;
}
}
}
